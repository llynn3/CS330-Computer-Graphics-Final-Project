...
{
	// Main overhead white light
	m_pShaderManager->setVec3Value("lightSources[0].position", 4.0f, 8.0f, 6.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.55f, 0.55f, 0.55f);
	...
	// Secondary warm side light
	m_pShaderManager->setVec3Value("lightSources[1].position", -4.0f, 5.0f, 4.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.12f, 0.08f, 0.05f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.8f, 0.5f, 0.3f);
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.8f, 0.5f, 0.3f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 0.4f);
	...
	scaleXYZ = glm::vec3(2.4f, 0.08f, 1.7f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 40.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-2.6f, 0.05f, 1.5f);
	...
	SetShaderColor(0.15f, 0.20f, 0.55f, 1.0f);
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(3.5f, 0.8f, 1.5f);
